...
const ARB_SEPOLIA_USDC           = "0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d"; // Circle USDC on Arbitrum Sepolia
const KEYSTONE_FORWARDER         = "0x76c9cf548b4179F8901cda1f8623568b58215E62"; // Production Keystone Forwarder (Arbitrum Sepolia)
const ARB_SEPOLIA_CHAIN_SELECTOR = 3478487238524512106n;                         // Chainlink chain selector for Arbitrum Sepolia
...
async function main() {
    ...
    if (balance === 0n) {
        throw new Error("Deployer wallet has no ETH — fund it with Arbitrum Sepolia ETH before deploying.");
    }
    ...
    // ── 4. StableGuardVault ──────────────────────────────────────────────────
    console.log("4/5  Deploying StableGuardVault (asset: Arbitrum Sepolia USDC)...");
    ...
    const deployment = {
        ...
        params: {
            ...
            chainSelector:     ARB_SEPOLIA_CHAIN_SELECTOR.toString(),
